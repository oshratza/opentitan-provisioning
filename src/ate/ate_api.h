...
enum {
  ...
  kTokenMaxSize = 32,	//@@ use kTokenSize256
...
typedef struct EndorseCertSignature {
  uint8_t raw[32];//@@ no sutible const?
...
typedef struct derive_token_params {
   ...
   * with zeroes.
   */
  uint8_t diversifier[kDiversificationStringSize];//@@ why not to use diversifier_bytes_t?
