 ...
 * @return The result of the operation.
 */
DLLEXPORT int RegisterDeviceTPM(ate_client_ptr client,
                                const device_id_t* deviceID, const void* certs,
                                const size_t certsSize, const void* pSN,
                                const size_t snSize,
                                const DeviceLifeCycle life_cycle,
                                const uint8_t year, const uint8_t week,
                                const uint16_t lot_num, const uint8_t wafer_id,
